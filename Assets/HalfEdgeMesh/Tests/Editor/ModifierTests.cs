...
public class ModifierTests
{
    ...
    public void TwistModifier_DoesNotReverseDirectionAtZeroPlane()
    {
        ...
        UnityEngine.Debug.Log($"Bottom vertex result: {bottomVertex}");
        UnityEngine.Debug.Log($"Top vertex result: {topVertex}");
        ...
        // This demonstrates no reversal issue - the behavior is consistent
    ...
    public void TwistModifier_HasLinearTwistProgression()
    {
        ...
        for (int i = 0; i < testPositions.Length; i++)
        {
            ...
            UnityEngine.Debug.Log($"Original position: {originalPos}");
            UnityEngine.Debug.Log($"Rotated position: {rotatedPos}");
            UnityEngine.Debug.Log($"Original XZ: {originalXZ}");
            UnityEngine.Debug.Log($"Rotated XZ: {rotatedXZ}");
            ...
            UnityEngine.Debug.Log($"Original angle: {math.degrees(originalAngle)}°");
            UnityEngine.Debug.Log($"Rotated angle: {math.degrees(rotatedAngle)}°");
            
            var deltaAngle = rotatedAngle - originalAngle;
            UnityEngine.Debug.Log($"Raw delta angle: {math.degrees(deltaAngle)}°");
            ...
            UnityEngine.Debug.Log($"Y={originalPos.y}: Expected={(math.PI/2f) * originalPos.y}, Measured={deltaAngle}, Degrees={math.degrees(deltaAngle)}");
        ...
        UnityEngine.Debug.Log($"Bottom: (1, -1, 0) -> {bottomResult}");
        UnityEngine.Debug.Log($"Top: (1, 1, 0) -> {topResult}");
    ...
    public void TwistModifier_FalloffWorksCorrectly()
    {
        ...
        for (int i = 0; i < testPositions.Length; i++)
        {
            ...
            UnityEngine.Debug.Log($"Y={originalPos.y}: Rotation={math.degrees(deltaAngle)}°");
        }
